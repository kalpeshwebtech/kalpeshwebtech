...
class NavigationRVAdapter(private var items: ArrayList<NavigationItemModel>, private var currentPos: Int) :
    ...
    override fun onBindViewHolder(holder: NavigationItemViewHolder, position: Int) {
        ...
        holder.itemView.navigation_icon.setColorFilter(ContextCompat.getColor(context, R.color.gray), PorterDuff.Mode.SRC_ATOP)
        holder.itemView.navigation_title.setTextColor(ContextCompat.getColor(context, R.color.gray))
        if (items[position].isLine){
